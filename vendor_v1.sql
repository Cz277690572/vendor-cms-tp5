...
CREATE TABLE `image`  (
  ...
  `update_time` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 139 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '图片总表' ROW_FORMAT = Dynamic;
...
INSERT INTO `image` VALUES (136, '/5037bffcdf09bc7c/b5261a08189ea4be.png', 1, NULL, 1585922795);
INSERT INTO `image` VALUES (137, '/92e953fad71f84b6/7c463eeddd5606ee.png', 1, NULL, 1585922795);
INSERT INTO `image` VALUES (138, '/92e953fad71f84b6/7c463eeddd5606ee.png', 1, NULL, 1585922903);
...
INSERT INTO `product` VALUES (6859225246, '濑尿虾寿司 100给', 10.00, 99, NULL, 7, '/5037bffcdf09bc7c/b5261a08189ea4be.png', 1, 1, 0, NULL, 1585922795, '描述11', 136);
INSERT INTO `product` VALUES (6859228052, '商品test', 0.10, 66, NULL, 3, '/92e953fad71f84b6/7c463eeddd5606ee.png', 1, 0, 0, NULL, 1585922903, '', 138);
...
INSERT INTO `product_image` VALUES (49, 137, NULL, 0, 6859225246);
...
INSERT INTO `product_property` VALUES (43, '保质期', '3天', 6859225246, NULL, 1585922795);
INSERT INTO `product_property` VALUES (44, 'j', 'k', 6859228052, NULL, 1585922903);
